...
export default {
    ...
    methods: {
        findData() {
            ...
            this.form = responseData.nestdetail.modelInfo;
            this.modelTotInfo = responseData.nestdetail.modelTotInfo; //模型综合评价
            this.eventInfo = responseData.nestdetail.eventInfo; //训练事件明细
            this.tableData.push(responseData.nestdetail);
            var option = responseData.nestdetail.eventList;
        ...
        selectevent() {
            let modelId = this.$route.query.id;
            this.eventDetail = getModelDteailByEvent;
        },
        onSubmit() {
            addModelInfo({
