            ...
            <el-col style="width:100%">
              <el-form-item label="是否数据增强" prop="is_increase">
                ...
                <el-checkbox-group v-model="form.checkList" size="mini" v-if="form.checkList1" style="width:200%">
                  ...
                  <el-checkbox label="词语交换和删除" border></el-checkbox>
                  <el-checkbox label="中外文反译（20种语言）" border></el-checkbox>
                    ...
                    <el-col>
                        <el-form-item label="选择预训练模型">
                            <el-col style="width:200%;">
                                ...
                                <el-radio v-model="form.pre_model" style="width:13%;margin-left:-3.8%" label="gpt" border>Gpt</el-radio>
                                <el-radio v-model="form.pre_model" style="width:13%;margin-left:-3.8%" label="xlnet" border>Xlnet</el-radio>
