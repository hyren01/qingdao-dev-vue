    ...
    <el-container style="height:100%">
        <el-aside :class="isCollapse==true?'aside1':'aside2'" style="position: fixed;left: 0;top: 0;">
            <happy-scroll color="rgba(204, 200, 200, 0.6)" size="5" resize>
                <!-- 导航 -->
                <el-menu :unique-opened='true' style="border:0" background-color="#15215c" text-color="#fff" active-text-color="rgba(255, 208, 75, 0.8)" @select="handleSelect" :collapse-transition="true" :collapse="isCollapse" class="el-menu-vertical-demo">
...
export default {
    ...
    mounted() {
        ...
        //         arr.push(children)
        //     }
        //     //console.log(JSON.stringify(JSON.parse(JSON.stringify(arr))))
