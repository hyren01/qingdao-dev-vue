...
<div class="app-container">
    <el-dialog title="模型列表" :visible.sync="dialogTableVisible" width="70%" style="overflow:hidden">
        <el-table ref="multipleTable" :data="tableData" height="400px" tooltip-effect="dark" style="width: 100%" @row-click="showRow" @current-change="handleCurrentChange">
            ...
            <el-table-column prop="create_date" label="创建日期" show-overflow-tooltip>
            </el-table-column>
        </el-table>
        <div class="btns">
    ...
    <div style="margin-top:60px;">
        <el-form :model="ruleForm" ref="ruleForm" label-width="120" class="demo-form-inline">
            <el-row>
                <el-col :span="6">
                    <el-form-item label="模型名称" prop="name" :rules="rule.default">
                        <el-input v-model="ruleForm.name" :disabled="true"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="6" :offset="4">
                    <el-form-item label="预测开始时间" prop="sample_start_date" :rules="rule.default">
                        <el-date-picker v-model="ruleForm.sample_start_date" type="date" placeholder="日期" value-format="yyyy-MM-dd">
                        </el-date-picker>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="6">
                    <el-form-item label="预测天数" prop="day" :rules="rule.default">
                        <el-input v-model="ruleForm.day"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="6" :offset="4">
                    <el-form-item label="预测说明" prop="remark" :rules="rule.default">
          ...
          <el-col :span="6" :offset="2">
            ...
            <el-row>
                ...
                <el-col :span="6">
                    <el-button type="warning" @click="forecastBtn('ruleForm')" :loading="loadingbut" style="margin-top:20px;margin-left:25px">
                        事件预测
                    </el-button>
                </el-col>
            </el-row>
